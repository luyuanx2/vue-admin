...
Mock.mock(/\/sys\/user\/delete\.*/, 'delete', userAPI.deleteUser)
// 部门相关
...
Mock.mock(/\/sys\/acl\/delete\.*/, 'delete', aclAPI.deleteAcl)
// 角色相关
...
Mock.mock(/\/sys\/role\/delete\.*/, 'delete', roleAPI.deleteRole)
// 权限操作记录
